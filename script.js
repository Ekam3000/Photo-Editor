...
onload = function () {
    const editor = document.getElementById("editor"); //image section 
    const context = editor.getContext("2d");// like pen in snakes game
    const toolbar = document.getElementById("toolbar"); //buttons section
